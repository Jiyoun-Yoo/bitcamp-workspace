...
- 연습 
  ...
  - 자바 프로젝트 실행하기
    - > gradle run
  - 자바 프로젝트 빌드하기 (고객에게 납품할 파일 만들기)
    - > gradle build (distributions 폴더 안에 tar 혹은 zip 파일을 넘기면 됨)
