...
public class Exam0141 {
  ...
  static class My {
    ...
    public int hashCode() {
      ...
      // 같은 문자열에 대해 같은 해시값을 리턴하도록 재정의되었다.
  ...
  public static void main(String[] args) {
    ...
    System.out.println(s1 == s2); // 서로 다른 객체이기 때문에 결과는 false
    System.out.println(s1.hashCode() == s2.hashCode()); // hashCode()가 재정의 되었기 때문에 true
    ...
    // hashCode() 메서드가 재정의되었기 때문에,
    // 두 개의 다른 객체가 같은 hashCode를 갖는다.
