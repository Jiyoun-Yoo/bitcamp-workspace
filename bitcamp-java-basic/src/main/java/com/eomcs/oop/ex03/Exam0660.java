...
public class Exam0660 {
  public static class A {
    ...
    //  - 바이트 코드(Exam0660$A.class)를 확인해 보라.
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 클래스가 로딩되는 경우
    //  1) 클래스 멤버 (변수와 메서드)를 사용할 때 클래스가 로딩되어있지 않다면,
    //      A.a = 100;
    //      A.m();
    //  2) 해당 클래스의 인스턴스를 생성할 때 클래스가 로딩되어있지 않다면,
    //      new A();
    //  3) 자바에서 제공하는 도구를 사용하여 클래스를 로딩할 때 클래스가 로딩되어있지 않다면,
