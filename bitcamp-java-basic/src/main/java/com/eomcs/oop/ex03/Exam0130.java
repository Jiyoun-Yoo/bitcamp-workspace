...
public class Exam0130 {
  ...
  public static void main(String[] args) {
    ...
    /*
     클래스 변수를 아래와 같이 인스턴스 변수처럼 사용하지 않도록 주의하자.
     컴파일 오류가 발생하지는 않지만, 바람직하지 않다!
    ...
    System.out.println(obj1.v1); // 200 출력
    System.out.println(obj2.v1); // 200 출력
...
//    - 그래도 없으면 오류를 띄운다.
//  2) 클래스 파일의 바이트코드 검증(Verify)
//    - 클래스의 바이트코드 유효성을 검사한다.
//  3) 클래스를 "Method Area 영역"에 로딩한다.
