...
public class Exam0910 {
  ...
  public static void main(String[] args) {
    ...
    // 모니터의 각 값들이 유효한 기본 값으로 초기화되지 않은 상태에서 모니터를 켠다면?
    // 까만 화면만 볼 뿐이다.
    // 사용자는 모니터가 고장난 줄 알고 AS를 요청할 것이다.

    // 그레서 모니터를 만든 후 출하하기 전에
    ...
    // 고객의 의견!
    //  => 모니터를 구매한 후 바로 사용할 수 있도록
    //     모니터의 속성 값들이 유효한 값으로 미리 초기화 되었으면 좋겠습니다.

    // 이 클래스를 사용하는 다른 개발자의 의견
    //  => 인스턴스의 메서드를 사용하는데 문제가 없도록
    //     인스턴스의 각 필드를 유효한 값으로 미리 초기화 했으면 좋겠습니다.
  }
