...
public class Exam0210 {
  public static void main(String[] args) {
    ...
    //  - nextLine()을 가동시키려면 스캐너에 대한 기본 정보가 필요하다. (기반 데이터)
    //    reference.nextLine()과 같이 사용해야 한다. Heap에 들어있는 reference를 알려줘야 한다.
    //    클래스 이름으로 호출할 수 없다.
    String str = keyScan.nextLine();

    // 기반 데이터 없이 바로 실행 가능한 메서드도 있다.
    //  - 클래스 이름으로 호출할 수 있다.
