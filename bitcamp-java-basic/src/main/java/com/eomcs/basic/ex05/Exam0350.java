...
//  => 다음과 같이 한 개의 점이 있다.
//     10001100 10010010 10101100 (변경전 색)
//   & 11011011 11011101 11111111 (빨간색과 초록색을 약화시키기)
//  -------------------------------
...
// 1920 * 1080 = 2076600 픽셀
// 1픽셀당 3byte 필요!
// Red(8bit) + Green(8bit) + Blue(8bit) 
//  => 3 byte/pixel
//  => 1677_7216 색상

// 207_3600pixel * 3byte = 622_8900 byte = 6082KB = 5.94MB

// 1000만 화소?
// 1000_0000 * 3 = 3000_0000 = 29_296KB = 28.6MB (raw data file)

// 80분짜리 영화
// 영화는 1초당 24장의 사진을 붙여 영상으로 만든 것
// 80 * 60 * 24 = 11_5200(장)
// 용량 
// 11_5200 * 6MB = 691200MB = 675GB ==> 4GB(손실 압축, MPEG)
